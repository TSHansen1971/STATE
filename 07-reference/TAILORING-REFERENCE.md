...
> **Document:** `07-reference/TAILORING-REFERENCE.md`  
> **Title:** Tailoring Reference  
> **Version:** 0.10  
> **Status:** Reference  
> **Created:** 2026-08-13  
...
This page is the compact reference for STATE Tailoring.
...
```text
Semantic Compression = permitted
Control Deletion      = not Tailoring
```
