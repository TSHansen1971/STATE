...
The Conceptual layer defines what STATE Engineering is independently of any particular workflow implementation, organizational topology or toolchain.
...
1. [`01-the-state-model.md`](01-the-state-model.md) — authoritative, baseline, candidate, accepted, rejected and inconclusive state concepts.
2. [`02-foundational-properties.md`](02-foundational-properties.md) — the defining properties that must remain present for the method to retain its identity.
3. [`03-role-actor-capability-authority.md`](03-role-actor-capability-authority.md) — the fundamental separation of role, responsibility, actor, capability and authority.
